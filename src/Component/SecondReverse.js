...
const SecondReverse = () => {
  ...
  const handleSubscriptionClick = () => {
    trackConversion("16783381103", "subscription_bottom_checkout_click");
    trackEvent("subscription_bottom_checkout_click", {
      currency: "USD",
      value: 0.01,
    });
  };
        ...
        <div className=" text-white  md:max-w-[50%] w-full mt-[5px] md:mt-0">
          <div className="bg-[#041e3a] py-[8px] text-center">
            ...
            <h3 className="text-2xl md:text-[31.2px] min-h-[22.4px] leading-[38.4px] font-playfair">
              RESTORE AMERICAN JOURNALISM
            </h3>
          </div>
          <div className="bg-white py-7 px-4 text-black text-center">
            <p className="text-[19.2px] leading-[24px] mb-[21px] font-opensans">
              &nbsp;&nbsp;There’s one paper that&nbsp;continues to uphold the
              finest traditions of American journalism:The New York Sun.
            </p>
            <p className="text-[19.2px] leading-[24px] mb-[21px] font-opensans">
              The New York Sun has served as the counterweight to <br></br>The
              New York Times for nearly 200 years. Now,<br></br> Americans who
              have lost faith in mainstream newspapers<br></br> are
              rediscovering the principled and patriotic voice of The<br></br>{" "}
              New York Sun.
            </p>
